 ...
 * Otherwise, if it is in the valid range, calculate if the year is a leap year abd return true if it is,
 * otherwise return false.
 * A year is a leap year if it is divisible by 4 but not by 100, or it is divisible by 400.
 * Example of input/Output:
 * ☻ isLeapYear(-1600); should return false since the prarameter is not in the range(1-9999) ☻
 * isLeapYear(1600); should return true since 1600 is a leap year
 * ☻ isLeapYear(2017); should rern false since 2017 us not a leap year
...
public class Programme_04_NumbersOfDaysInMonth {
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------------------");
        //5 Oututs to get days in a month
