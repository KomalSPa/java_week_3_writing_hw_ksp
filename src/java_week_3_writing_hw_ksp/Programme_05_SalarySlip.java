 ...
 * TA = Basic salary 9%
 * PH= Basic salary 20%
 * Gross salary = basic salary + HRA + TA + DA -PH
 * Print n following format
...
public class Programme_05_SalarySlip {
    public static void main(String[] args) {
        ...
        int employeeId = v1.nextInt();

        System.out.println("Enter Basic Salary");
        double basicSalary  =   v1.nextDouble();
        ...
        double pf = calculatePH(basicSalary);
    ...
    public static double calculateHRA(double basicSalary) {
        ...
        public static  double calculateTA(double basicSalary) {
            ...
            // Calculating PF
        public static double calculatePH(double basicSalary){
