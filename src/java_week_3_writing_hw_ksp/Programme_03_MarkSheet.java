...
/**
 * Write a java programe to input student Name, Roll No, and three subjects Math, Science and
 * English makrs (marks is between 0 to 100 and if it is out of range print error message "Invalid
 * Input, Marks should between 0 to 100") and find out torlal, percentage and result.
